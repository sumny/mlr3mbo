...
#`   In which direction is the acquistion function optimized?
#`   It will always be minimized, maximized (eg. ei) or the direction is the same as for the objective (eg. cb)
